        ...
        <div id="main" class="row-fluid">
            <div id="main-left" class="span8">
                <div id="slider" class="clearfix">
                    <div id="slide-left" class="flexslider span8" style="height: 437px;">
                        <ul class="slides">
                        <?php for ($i=0; $i < 5 ; $i++) {  ?>
                     ...
                     <div class="span3" style="background-color: white; height: 437px; width: 33%; display: inline-block; padding: 5px 5px 5px 5px; margin-left: 5px;">
<a href="http://crm-in1.messefrankfurt.com/services/vor/registration_form.aspx?exhibition_id=273"><img src ="Texprocess_221_471.png"></a></div>
        ...
        <div class="clearfix"  >
                    <div class="left span3 " style="background-color: #e0e7ff; padding: 10px 10px 10px 10px; margin-left: 0px;">
                        ...
                        <article class="post" style="height:550px">
                                ...
                                <a href="news.php?id=<?php echo $a_slugs[0]; ?>" title="<?php echo $a_headlines[0]; ?>" rel="bookmark"><?php echo $a_headlines[0]; ?></a>
                                    ...
                                    <span class="date" style="float: right; color: black"><b><?php echo $r_card_date[0]; ?></b></span><br>

                                </div>
                                <p style="text-align: justify; color: black"><?php echo $a_contents[0]; ?></p>
                    ...
                    <div class="right span3" style="background-color: #ffefef; padding: 10px 10px 10px 10px;  margin-left: 0px;">
                       <h3 class="title" style="width: 95%;background-color: #376980;"><a href="category.php?cat=Textile" title="Textile"><span>Textile</span></a></h3>
                            <div class="row-fluid">
                                ...
                                <p style="text-align: justify; color: black""><?php echo $t_contents[0]; ?></p>
                    ...
                    <div class="right span3" style="background-color: #e0e7ff; padding: 10px 10px 10px 10px;  margin-left: 0px; ">
                        <h3 class="title" style="width: 95%;background-color: #376980;"><a href="category.php?cat=Fashion" title="Fashion"><span>Fashion</span></a></h3>
                            <div class="row-fluid">
                                ...
                                <p style="text-align: justify; color: black""><?php echo $f_contents[0]; ?></p>
                    ...
                    <div class="right span3" style="background-color: #ffefef; padding: 10px 10px 10px 10px;  margin-left: 0px;">
                        <h3 class="title" style="width: 95%;background-color: #376980;"><a href="category.php?cat=Corporate" title="Corporate"><span>Corporate</span></a></h3>
                            <div class="row-fluid">
                                ...
                                <p style="text-align: justify; color: black""><?php echo $c_contents[0]; ?></p>
                    ...
                    <div class="clearfix"  >
                    <div class="left span3 " style="background-color: #ffefef; padding: 10px 10px 10px 10px;  margin-left: 0px;">
                    ...
                    <div class="right span3" style="background-color: #e0e7ff; padding: 10px 10px 10px 10px;  margin-left: 0px;">
                       <h3 class="title" style="width: 95%;background-color: #376980;"><a href="category.php?cat=Events" title="Textile"><span>Events</span></a></h3>
                            <div class="row-fluid">
                                ...
                                <p style="text-align: justify; color: black"><?php echo $eve_contents[0]; ?></p>
                    ...
                    <div class="right span3" style="background-color: #ffefef; padding: 10px 10px 10px 10px;  margin-left: 0px;">
                        <h3 class="title" style="width: 95%;background-color: #376980;"><a href="category.php?cat=Technical textile"><span>Technical textile</span></a></h3>
                            <div class="row-fluid">
                                ...
                                <p style="text-align: justify; color: black"><?php echo $tt_contents[0]; ?></p>
                    ...
                    <div class="right span3" style="background-color: #e0e7ff; padding: 10px 10px 10px 10px;  margin-left: 0px;">
                        <h3 class="title" style="width: 95%;background-color: #376980;"><a href="category.php?cat=Retail" title="Corporate"><span>Retail</span></a></h3>
                            <div class="row-fluid">
                                ...
                                <p style="text-align: justify; color: black"><?php echo $r_contents[0]; ?></p>

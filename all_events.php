...
<div id="page">
    ...
    <div id="content" class="container"  style="padding: 13px 10px 40px 40px;">

        <div id="main" class="row-fluid" >
            <div id="main-left" class="span8">
                <?php
                if ($page_val <= $totalIds) {
                    $start = $page_val-4;

                    //echo $page_val;
                    for ($i=$start; $i <$page_val; $i++) {  ?>
                ...
                <div class="pagination magz-pagination" style="background-color: white;"><span class='page-numbers current' ><a   href="<?php if ($page_val < $totalIds) {$next= $page_val+4; echo "all_events.php?p=$next" ;} if ($page_val == $totalIds) { echo '#!';} ?>"><?php if ($page_val < $totalIds) { echo "Next";} if ($page_val == $totalIds) { echo "No More to load";} ?></a></span>
